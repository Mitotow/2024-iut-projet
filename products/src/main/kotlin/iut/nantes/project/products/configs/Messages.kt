...
object Messages {
    ...
    const val NO_ID_GIVEN = "Missing ID value in request"
    ...
    const val FAMILY_DELETE_FAIL = "A product still used the specified family, cannot delete the family"
    ...
    // Miscellenous
    const val NO_RESOURCE_FOUND = "The resource was not found"
}
